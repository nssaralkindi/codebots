...
buttons_ques = [
    [
        InlineKeyboardButton("بايجرام", callback_data="pyrogram"),
        InlineKeyboardButton("تليثون", callback_data="telethon"),
    ],
    [
        InlineKeyboardButton("بايجرام بوت", callback_data="pyrogram_bot"),
...
gen_button = [
    [
        InlineKeyboardButton(text="- ابداء الان", callback_data="generate")
    ]
]
...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    user_id = msg.chat.id
    api_id_msg = await bot.ask(user_id, "🎮حسنـا قم بأرسال الـ  **ᴀᴩɪ_ɪᴅ** ᴛᴏ ᴩʀᴏᴄᴇᴇᴅ.\n\nاضغط /skip لاستخراج الجلسه برقم الحساب فقط.", filters=filters.text)
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @BtZkBot\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ 🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @NNINB 🥺"
    try:
        if not is_bot:
